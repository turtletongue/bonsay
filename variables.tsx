...
export const mainScreenConfig = {
  ...
  description: (
    <>
      Несколько деревьев прибыли в наш магазин из Киото. Не упуститите
      возможность насладиться красотой бонсай-искусства.
    </>
  ),
      ...
      paragraphs: [
        {
          id: 3,
          content:
            'Мы дорожим каждым нашим клиентом, поэтому высокое качество товаров - приоритет для нас. Вы всегда можете задать интересующие вас вопросы по телефону или по почте и получить подробную консультацию.',
        },
        {
          id: 4,
          content:
...
export const DEFAULT_PRICE_MAXIMUM = '1000000';
