...
export const Card = ({ title, price, imageUrl }: CardProps) => {
  return (
    <div className='group flex flex-col overflow-hidden border-2 border-decoration text-center font-hanuman text-primary cursor-pointer'>
      <div className='relative flex justify-center items-center'>
        <div className='overflow-hidden'>
          <Image
            ...
            height={261}
            alt={title}
            className='filter group-hover:blur transition'
          />
        </div>
